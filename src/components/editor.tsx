 ...
 * Persistence: publishing exports blocks → markdown (lossy) → the record's
 * `content` union, with a plaintext projection of it in `textContent`; drafts
 * store the block JSON itself (lossless) and load it back via `initialBlocks`.
 * Reopening a published post parses the union's markdown back into blocks.
 */
